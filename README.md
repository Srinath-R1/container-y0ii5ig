...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y0ii5ig.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y0ii5ig.containers.anotherwebservice.com/
...
```
git clone git@github.com:Srinath-R1/container-y0ii5ig.git
cd container-y0ii5ig
```
...
```
docker attach container-y0ii5ig
```
